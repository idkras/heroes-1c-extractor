...
def fix_imports_in_file(file_path):
    ...
    try:
        ...
        replacements = [
            ...
            (
                r"from heroes_mcp.src.heroes_mcp_server import",
                "from heroes_mcp.src.heroes_mcp_server import",
            ),
            (
                r"import heroes_mcp.src.heroes_mcp_server as mcp_server",
                "import heroes_mcp.src.heroes_mcp_server as mcp_server",
            ),
            (r"from mcp_server\.", "from heroes_mcp.src."),
            # credentials_manager → shared.credentials_manager
            (
                r"from shared.credentials_manager import",
                "from shared.credentials_manager import",
            ),
            (
                r"import shared.credentials_manager as credentials_manager",
                "import shared.credentials_manager as credentials_manager",
            ),
            (
            ...
            (
                r"from heroes_mcp\.src\.credentials_manager import",
                "from shared.credentials_manager import",
            ),
