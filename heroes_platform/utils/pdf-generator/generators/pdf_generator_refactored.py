...
class RefactoredPDFGenerator:
    ...
    def _convert_md_to_pdf_direct(self, md_file_path: str, output_pdf_path: str) -> bool:
        """
        ...
        try:
            ...
            cmd = [
                ...
                '--standalone',
                '--from', 'markdown+raw_html+task_lists',
                '--to', 'pdf',
                '--metadata', 'lang=ru'
            ]
    ...
    def _convert_md_to_pdf_via_html(self, md_file_path: str, output_pdf_path: str) -> bool:
        """
