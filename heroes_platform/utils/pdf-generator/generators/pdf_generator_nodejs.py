...
class NodeJSPDFGenerator:
    ...
    def convert_md_to_pdf(
        self, md_file_path: str, output_pdf_path: str, custom_css: Optional[str] = None
    ) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                cmd = [
                    ...
                    css_path,
                    "--pdf-options",
                    '{"format": "A4", "margin": {"top": "20mm", "right": "20mm", "bottom": "20mm", "left": "20mm"}}',
                ]
...
def convert_md_to_pdf_nodejs(
    md_file_path: str, output_pdf_path: str, custom_css: Optional[str] = None
) -> dict[str, Any]:
...
def convert_md_to_pdf_nodejs_advanced(
    md_file_path: str, output_pdf_path: str, options: Optional[dict[str, Any]] = None
) -> dict[str, Any]:
    """Удобная функция для конвертации с расширенными опциями"""
    generator = NodeJSPDFGenerator()
    return generator.convert_with_advanced_options(
        md_file_path, output_pdf_path, options
    )
