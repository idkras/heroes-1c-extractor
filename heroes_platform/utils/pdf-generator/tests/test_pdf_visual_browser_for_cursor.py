...
async def test_pdf_visual_quality_browser():
    ...
    pdf_path = Path(
        "[projects]/rick.ai/knowledge base/in progress/when new lead come/2. when security asked policy/Rick_ai_Security_Documentation_FINAL.pdf"
    )
    ...
    async with async_playwright() as p:
        ...
        browser = await p.chromium.launch(
            headless=False
        )  # headless=False для визуального контроля
        ...
        try:
            ...
            visual_tests = {
                ...
                "Заголовок видим": "Rick.ai" in page_content
                or "Информация о безопасности" in title,
