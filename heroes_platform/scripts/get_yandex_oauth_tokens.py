...
def exchange_code_for_tokens(client_id, client_secret, auth_code):
    ...
    try:
        ...
        if not refresh_token:
            print("WARNING: Refresh token не получен. Возможно, нужно переавторизоваться.")
            return None
