...
def analyze_products_data():
    """
    Детальный анализ таблицы _DOCUMENT12259_VT12322 с товарами
    """
    print("🔍 Детальный анализ таблицы _DOCUMENT12259_VT12322 с товарами")
    print("=" * 60)
    ...
    try:
        with open('raw/1Cv8.1CD', 'rb') as f:
            ...
            # Анализируем таблицу _DOCUMENT12259_VT12322
            ...
            if table_name in db.tables:
                ...
                for idx, (row_num, row) in enumerate(non_empty_rows[:10]):
                    print(f"\n📄 Запись #{row_num}:")
                ...
                print(f"\n🔍 Поиск ключевых слов:")
                keywords = ['цвет', 'rose', 'tulip', 'flower', 'товар', 'номенклатура', 'наименование', 'описание', 'акт', 'счет', 'фактур']
                found_keywords = []
                
                for row_num, row in non_empty_rows[:20]:
                    for field_name in table.fields.keys():
                        try:
                            value = row[field_name]
                ...
                if found_keywords:
                    ...
                    for row_num, field_name, keyword, value in found_keywords[:5]:
