...
class TestDocumentSearch:
    ...
    def test_search_by_store(self):
        ...
        for doc in store_docs:
            ...
            assert "ПЦ" in store_name, f"Документ {doc[0]} не содержит информации о магазине"
    ...
    def test_search_by_amount_range(self):
        ...
        for doc in high_amount_docs:
            ...
            assert amount > 10000, f"Документ {doc[0]} имеет сумму {amount}, что меньше 10000"
    ...
    def test_search_by_date_range(self):
        ...
        for doc in date_docs:
            ...
            assert date != "N/A" and date != "", f"Документ {doc[0]} имеет некорректную дату: {date}"
    ...
    def test_search_by_blob_content(self):
        ...
        for doc in flower_docs:
            ...
            assert any(keyword in blob_content.lower() for keyword in ["флор", "роз", "тюльпан", "хризантем"]), \
    ...
    def test_complex_search_queries(self):
        ...
        for doc in complex_query:
            ...
            assert "флор" in blob_content.lower(), f"Документ {doc[0]} не содержит флористической информации"
            assert amount > 5000, f"Документ {doc[0]} имеет сумму {amount}, что меньше 5000"
            assert "ПЦ" in store_name, f"Документ {doc[0]} не содержит информации о магазине ПЦ"
    ...
    def test_document_filtering(self):
        ...
        for doc in filtered_docs:
            ...
            assert doc_type in ['ФЛОРИСТИКА', 'ДЕКОР', 'МОНО БУКЕТ'], \
