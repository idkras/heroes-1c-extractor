...
Основная реализация перемещена в advising_platform/scripts/incidents/process_incidents.py
"""
...
target_path = os.path.join('advising_platform', 'scripts', 'incidents', 'process_incidents.py')
